            ...
            <div class="card">
                ...
                <div class="card-body post-dropzone">
                    <div class="form-group">
                        <div class="row">
                            <label for="logo" class=" col-md-4"><?php echo app_lang('site_logo'); ?> (175x40) </label>
                            <div class=" col-md-8">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label for="favicon" class="col-md-4"><?php echo app_lang('favicon'); ?> (32x32)</label>
                            <div class="col-lg-8">
                                <div class="float-start mr15">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label for="show_background_image_in_signin_page" class=" col-md-4"><?php echo app_lang('show_background_image_in_signin_page'); ?></label>
                            <div class="col-md-8">
                                <?php
                                echo form_dropdown(
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label class=" col-md-4"><?php echo app_lang('signin_page_background'); ?></label>
                            <div class=" col-md-8">
                                <div class="float-start mr15">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label for="app_title" class=" col-md-4"><?php echo app_lang('app_title'); ?></label>
                            <div class=" col-md-8">
                                <?php
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label for="app_token_facebook" class=" col-md-4"><?php echo app_lang('app_token_facebook'); ?></label>
                            <div class=" col-md-8">
                                <?php
                                echo form_textarea(array(
                                    "id" => "app_token_facebook",
                                    "name" => "app_token_facebook",
                                    "value" => get_setting('app_token_facebook'),
                                    "class" => "form-control",
                                    "placeholder" => app_lang('app_token_facebook'),
                                    "data-rule-required" => true,
                                    "data-msg-required" => app_lang("field_required"),
                                ));
                                ?>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label for="accepted_file_formats" class=" col-md-4"><?php echo app_lang('accepted_file_format'); ?></label>
                            <div class=" col-md-8">
                                <?php
                                echo form_input(array(
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label for="rows_per_page" class=" col-md-4"><?php echo app_lang('rows_per_page'); ?></label>
                            <div class="col-md-8">
                                <?php
                                echo form_dropdown(
                                        "rows_per_page", array(
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label for="scrollbar" class=" col-md-4"><?php echo app_lang('scrollbar'); ?></label>
                            <div class="col-md-8">
                                <?php
                                echo form_dropdown(
                                        "scrollbar", array(
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label for="item_purchase_code" class=" col-md-4"><?php echo app_lang('item_purchase_code'); ?></label>
                            <div class=" col-md-8">
                                <?php
                                echo form_input(array(
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label for="show_theme_color_changer" class=" col-md-4"><?php echo app_lang('show_theme_color_changer'); ?></label>
                            <div class="col-md-8">
                                <?php
                                echo form_dropdown(
                    ...
                    <div class="form-group color-plate" id="settings-color-plate">
                        <div class="row">
                            <label for="default_theme_color" class="col-md-4"><?php echo app_lang('default_theme_color'); ?></label>
                            <div class="col-md-8">
