            ...
            <ul class="permission-list">
                ...
                <?php if ($login_user->is_admin) { ?>
                    <li>
                        ...
                        <div>
                            <?php 
                            echo form_checkbox("can_manage_list_of_assignation", "1", $can_manage_list_of_assignation ? true : false, "id='can_manage_list_of_assignation' class='manage_project_section form-check-input'");
                            ?>
                            <label for="can_manage_list_of_assignation"><?php echo app_lang("list_of_assignation"); ?></label>
                        </div>
                    </li>
                <?php } ?>
                <li>
