<div id="page-content" class="page-wrapper clearfix">
    <div class="card">
        <div class="page-title clearfix">
            ...
            <?php echo modal_anchor(get_uri("email_templates/modal_template"), "<i data-feather='plus-circle' class='icon-16'></i> A&ntilde;adir plantilla de correo", array("class" => "btn btn-default", "title" => app_lang('email_templates'))); ?>
            </div>
        </div>
