            ...
            <div class="form-group">
                <div class=" col-md-12">
                    <?php
                        ...
                        $phoneWhatsapp=trim($user_info->phone); 
                        $message='<div style="background-image: url(https://grupodaxi.site/files/system/wallpaper.jpg); background-size: cover; padding: 50px 0; ">
                        <div style="max-width:640px; margin:0 auto; ">
                            ...
                            <div style="padding: 20px; background-color: rgb(255, 255, 255);">TEXTO DEL CORREO<br>
                                <div dir="ltr" data-smartmail="gmail_signature">
                                    <div dir="ltr">
                                    <br><br><br><br>
                                    <a href="https://api.whatsapp.com/send?text=Estoy%20interesado%20en%20recibir%20más%20información%20sobre%20Mukta%20Residencial&phone=+52'.$phoneWhatsapp.'"><img src="https://grupodaxi.site/files/images/whatsapp.png" data-image-whitelisted="" class="CToWUd" width="260" height="90">
                                    </a>
                                    <br><br>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding:0px;vertical-align:middle">
                                                        ...
                                                        <p color="#000000"
                                                            ...
                                                            &nbsp; &nbsp; &nbsp;<span
                                                                style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;color:rgb(34,34,34);font-size:medium">'.$user_info->job_title.'</span></p>
                                                        <p color="#000000"
                                                            style="font-family:Arial;margin:0px;color:rgb(0,0,0);font-size:14px;line-height:22px">&nbsp;
                                                            &nbsp; &nbsp; &nbsp;Grupo Daxi</p>
                                                        <table
                                                            ...
                                                            <tbody>
                                                                <tr style="vertical-align:middle" height="25">
                                                                    ...
                                                                    <td style="padding:0px;color:rgb(0,0,0)"><a href="tel:800+942+2740" color="#000000"
                                                                            ...
                                                                            2740&nbsp;</a>
                                                                        <font size="2">| '.$user_info->phone.'</font>
                                                                    </td>
                                                                </tr>
                                                                <tr style="vertical-align:middle" height="25">
                                                                    <td style="vertical-align:middle" width="30">
