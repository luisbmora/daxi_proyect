...
class Email_templates extends Security_Controller
{
    ...
    public function send_email_template()
    {
        ...
        try {
            ...
            $mail->SMTPSecure = 'tls';
            $mail->Port = 587;
            $mail->setFrom($this->login_user->email, 'CRM Grupo Daxi');
            $mail->addReplyTo($this->login_user->email, $this->login_user->first_name."".$this->user_login->last_name);
    ...
    function new () {
        ...
        $body_message = str_replace("^nbsp;", " ", $this->request->getPost("custom_message"));
        

        $save_id = $this->Email_templates_model->ci_save_new($template_name, $body_message, $id);
    ...
    public function list_data()
    {
        ...
        $options["user_id"] = $this->login_user->id;
        $options["admin"] = $this->login_user->is_admin;
    ...
    public function list_data_mails()
    {
        ...
        $options = array(
            ...
            "admin" => $this->login_user->is_admin
        );
    ...
    public function view_mail()
    {
        ...
        $id = $_REQUEST['id'];
        $view_data=array();
        $view_data['model_info'] = $this->Email_templates_model->view_detail_mail($id)->getResult();
