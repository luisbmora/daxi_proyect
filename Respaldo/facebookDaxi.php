...
if(htmlspecialchars($_POST["Inversion"]) != ''){
    mysqli_query($conn, "INSERT INTO `_notes` VALUES (null, 1, NOW(), '".$_POST['Inversion']."', '', 0, ".$ClientID.", ".$UserID.", '', 'a:0:{}', 0, 0);");
}
    ...
    <div style="max-width:640px; margin:0 auto; ">
        ...
        <div style="padding: 20px; background-color: rgb(255, 255, 255);">
            ...
            <p style=""><span style="color: rgb(85, 85, 85); font-size: 14px; line-height: 20px;"><span
                        style="font-weight: bold;">Se ha puesto en contacto un lead nuevo mediante la página de facebook de grupodaxi</span></span></p>
            <br>
            <p style=""><span style="color: rgb(85, 85, 85); font-size: 14px; line-height: 20px;">
                    Nombre: '.$company_name.'<br>
                    Télefono: '.$phone.'<br>
                    Email: '.$email.'<br>
                    Inversión: '.$htmlspecialchars($_POST["Inversion"]).'<br>
                    Formulario: Página de facebook de mukta
                </span></p>
