...
class Team_members extends Security_Controller {
    ...
    private function _make_row($data, $custom_fields) {
        ...
        $assigned_link = "";
        if ($this->login_user->is_admin && $this->login_user->id != $data->id) {
            $assigned_link = js_anchor("<i data-feather='x' class='icon-16'></i>", array('title' => app_lang('job_assign'), "class" => "update", "data-id" => $data->id, "data-action-url" => get_uri("team_members/assign"), "data-action" => "assign-confirmation"));
        }
