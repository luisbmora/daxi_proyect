...
class Settings extends Security_Controller {
    ...
    function save_general_settings() {
        $settings = array("site_logo", "favicon", "show_background_image_in_signin_page", "show_logo_in_signin_page", "app_title", "accepted_file_formats", "rows_per_page", "item_purchase_code", "scrollbar", "enable_rich_text_editor", "show_theme_color_changer", "default_theme_color", "app_token_facebook");
    ...
    //de la linea de abajo, para mas informaci¨®n
    ...
    //Destinatarios
    $mail->setFrom($this->request->getPost("email_smtp_user"), 'CRM Grupo Daxi');
    $mail->AddAddress($this->request->getPost("send_test_mail_to_mail"));
  //  $mail->AddAddress("contacto@grupodaxi.com");
    // Contenido
    $mail->isHTML(true);                          
    $mail->Subject = 'Enviando mensaje de pruebaLeads de Grupodaxi.com';
    ...
    $mail->Body = '<div style="background-color: #eeeeef;padding: 50px 0; background-image: url(http://grupodaxi.com/crm/files/system/system_file616467badd94e-proyectos-inmobiliarios.jpeg);">
                <div style="max-width:640px; margin:0 auto; ">
                    <div
                        ...
                        <h1>Probando configuraci¨®n de correos</h1>
                    </div>
                    <div style="padding: 20px; background-color: rgb(255, 255, 255);">
                        <p style=""><span
                                style="color: rgb(85, 85, 85); font-size: 14px; line-height: 20px;">Hola,'.$this->request->getPost("email_smtp_user").'</span><span
            ...
            if ($mail->send()) {
                ...
                echo json_encode(array("success" => false, 'No se pudo enviar el correo '));
            }
        ...
        public function sendMailNew($SMTPSecure,$Host,$Port,$Username,$Password,$Mailer,$SMTPAuth,$CharSet,$SMTPDebug){   

            $url = "http://localhost/email/index.php";
