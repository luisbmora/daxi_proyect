...
class Roles extends Security_Controller {
    ...
    function permissions($role_id) {
        if ($role_id) {
            ...
            $view_data['can_manage_list_of_assignation'] = get_array_value($permissions, "can_manage_list_of_assignation");
    ...
    function save_permissions() {
        ...
        if ($this->login_user->is_admin) {
            ...
            $can_manage_list_of_assignation = $this->request->getPost('can_manage_list_of_assignation');
            ...
            $can_manage_list_of_assignation = get_array_value($permissions, "can_manage_list_of_assignation");
        ...
        $permissions = array(
            ...
            "can_manage_list_of_assignation" => $can_manage_list_of_assignation,
