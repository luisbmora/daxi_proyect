        ...
        <div class="col-sm-9 col-lg-10">
            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                ...
                                echo form_input(array(
                                    ...
                                    "class" => "form-control",
                                    "placeholder" => "Déjelo en blanco si no está interesado en enviar correo de prueba",
                                ));
                                ?>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label for="send_test_mail_to" class=" col-md-2">A donde enviar correo de prueba</label>
                            <div class="col-md-10">
                                <?php
                                echo form_input(array(
                                    "id" => "send_test_mail_to_mail",
                                    "name" => "send_test_mail_to_mail",
                                    "value" => get_setting('send_test_mail_to_mail'),
                                    "class" => "form-control",
                                    "placeholder" => "Teclee el mail a donde enviaremos el correo de prueba",
                                ));
                                ?>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    function Success(mensaje){
        console.log("Entro");
        appLoader.hide();
        appAlert.success(mensaje, {duration: 10000});
    }
</script>