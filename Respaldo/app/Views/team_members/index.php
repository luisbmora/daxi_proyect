...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#team_member-table").appTable({
            ...
            columns: [
                {title: 'Foto de perfil', "class": "w20 text-center"},
                {title: "<?php echo app_lang("name") ?>","class":"w20"},
        ...
        <?php echo $custom_field_headers; ?>,
                ...
                {visible: visibleDelete, title: "<?php echo app_lang("delete") ?>", "class": "text-center option w5"},
                {visible: visibleAssigned, title: "<?php echo app_lang("job_assign") ?>", "class": "text-center option w5"}
            ],
