            ...
            <div class="card">
                ...
                <div id="app-update-container" class="card-body font-14">
                    ...
                    <?php if (count($installable_updates) || count($downloadable_updates)) { ?>
                        ...
                        echo "<p>Sin actualizaciones pendientes.</p>";
                    }
                    ?>
                    ...
                    <p>
                       <?php
                            if ($supported_until) {
                                if ($has_support) {
                                    echo $supported_until. "<span class='badge large bg-primary ml5'>Soportado</span> ";
                                } else {
                                    echo $supported_until. "<span class='badge large bg-danger ml5'>Soporte caducado</span> ";
                                    echo "<br>Para adquirir soporte, visite <a href='https://yocontigo-it.mx/'>aquí</a>.";
                                }
                            }
                            ?>
                    </p>
