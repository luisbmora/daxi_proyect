...
if (!function_exists('send_app_mail')) {
    ...
    function send_app_mail($to, $subject, $message, $optoins = array(), $convert_message_to_html = true) {
        ...
        $mail->Password   = decode_password(get_setting('email_smtp_pass'), "email_smtp_pass");
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port       = get_setting("email_smtp_port");
        //Destinatarios
        $mail->setFrom(get_setting("email_smtp_user"), 'CRM Grupo Daxi');
        $mail->AddAddress($to);
    //  $mail->AddAddress("contacto@grupodaxi.com");
        ...
        if (is_array($attachments)) {
            foreach ($attachments as $value) {
                ...
                $mail->AddAttachment(trim($file_path), "attachment", $file_name);
            }
        }
